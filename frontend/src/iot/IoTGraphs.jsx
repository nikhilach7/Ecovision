...
export default function IoTGraphs({ history, loading, error }) {
  ...
  return (
    <div className="grid gap-5 xl:grid-cols-2">
      ...
      <MetricChart title="Waste Level Trend (0/1)" data={history} dataKey="binStatus" stroke="#f59e0b" />
      <MetricChart title="Distance Trend (cm)" data={history} dataKey="distance" stroke="#06b6d4" />
      <MetricChart title="Bin Status Trend (%)" data={history} dataKey="wasteLevel" stroke="#8b5cf6" />
    </div>
  );
}
